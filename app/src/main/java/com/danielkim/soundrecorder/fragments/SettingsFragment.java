...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        highQualityPref.setChecked(MySharedPreferences.INSTANCE.getPrefHighQuality(getActivity()));
        highQualityPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                MySharedPreferences.INSTANCE.setPrefHighQuality(getActivity(), (boolean) newValue);
                return true;
            }
        });
